...
func (r ApiAddHistoryRequest) Execute() (*os.File, *_nethttp.Response, error) {
 ...
 * @return *os.File
 */
func (a *EnclaveServiceApiService) AddHistoryExecute(r ApiAddHistoryRequest) (*os.File, *_nethttp.Response, error) {
	var (
...
func (r ApiApproveEnclaveRequest) Execute() (*os.File, *_nethttp.Response, error) {
 ...
 * @return *os.File
 */
func (a *EnclaveServiceApiService) ApproveEnclaveExecute(r ApiApproveEnclaveRequest) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiAssignEnclaveAgentRequest) Execute() (*os.File, *_nethttp.Response, error) {
 ...
 * @return *os.File
 */
func (a *EnclaveServiceApiService) AssignEnclaveAgentExecute(r ApiAssignEnclaveAgentRequest) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiAttestateEnclaveRequest) Execute() (*os.File, *_nethttp.Response, error) {
 ...
 * @return *os.File
 */
func (a *EnclaveServiceApiService) AttestateEnclaveExecute(r ApiAttestateEnclaveRequest) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiCreateEnclaveRunRequestRequest) Execute() (*os.File, *_nethttp.Response, error) {
 ...
 * @return *os.File
 */
func (a *EnclaveServiceApiService) CreateEnclaveRunRequestExecute(r ApiCreateEnclaveRunRequestRequest) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetEnclaveRequest) Execute() (*os.File, *_nethttp.Response, error) {
 ...
 * @return *os.File
 */
func (a *EnclaveServiceApiService) GetEnclaveExecute(r ApiGetEnclaveRequest) (*os.File, *_nethttp.Response, error) {
	var (
...
func (r ApiGetEnclaveTypesRequest) Execute() (*os.File, *_nethttp.Response, error) {
 ...
 * @return *os.File
 */
func (a *EnclaveServiceApiService) GetEnclaveTypesExecute(r ApiGetEnclaveTypesRequest) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetEnclavesRequest) Execute() (*os.File, *_nethttp.Response, error) {
 ...
 * @return *os.File
 */
func (a *EnclaveServiceApiService) GetEnclavesExecute(r ApiGetEnclavesRequest) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiKillEnclaveRequest) Execute() (*os.File, *_nethttp.Response, error) {
 ...
 * @return *os.File
 */
func (a *EnclaveServiceApiService) KillEnclaveExecute(r ApiKillEnclaveRequest) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
type ApiRedistTestRequest struct {
	ctx _context.Context
	ApiService *EnclaveServiceApiService
}


func (r ApiRedistTestRequest) Execute() (*os.File, *_nethttp.Response, error) {
	return r.ApiService.RedistTestExecute(r)
}

/*
 * RedistTest Method for RedistTest
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiRedistTestRequest
 */
func (a *EnclaveServiceApiService) RedistTest(ctx _context.Context) ApiRedistTestRequest {
	return ApiRedistTestRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return *os.File
 */
func (a *EnclaveServiceApiService) RedistTestExecute(r ApiRedistTestRequest) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnclaveServiceApiService.RedistTest")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/enclaves/test/redis"
