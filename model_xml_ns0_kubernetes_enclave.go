...
type XmlNs0KubernetesEnclave struct {
	// 
...
func (o XmlNs0KubernetesEnclave) MarshalJSON() ([]byte, error) {
...
type NullableXmlNs0KubernetesEnclave struct {
	value *XmlNs0KubernetesEnclave
	isSet bool
}

func (v NullableXmlNs0KubernetesEnclave) Get() *XmlNs0KubernetesEnclave {
	return v.value
}

func (v *NullableXmlNs0KubernetesEnclave) Set(val *XmlNs0KubernetesEnclave) {
	v.value = val
	v.isSet = true
}

func (v NullableXmlNs0KubernetesEnclave) IsSet() bool {
	return v.isSet
}

func (v *NullableXmlNs0KubernetesEnclave) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableXmlNs0KubernetesEnclave(val *XmlNs0KubernetesEnclave) *NullableXmlNs0KubernetesEnclave {
	return &NullableXmlNs0KubernetesEnclave{value: val, isSet: true}
}

func (v NullableXmlNs0KubernetesEnclave) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableXmlNs0KubernetesEnclave) UnmarshalJSON(src []byte) error {
	v.isSet = true
