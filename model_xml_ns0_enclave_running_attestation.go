...
func (o XmlNs0EnclaveRunningAttestation) MarshalJSON() ([]byte, error) {
	...
	serializedXmlNs0EnclaveRunningAttestationAllOf, errXmlNs0EnclaveRunningAttestationAllOf := json.Marshal(o.XmlNs0EnclaveRunningAttestationAllOf)
	if errXmlNs0EnclaveRunningAttestationAllOf != nil {
		return []byte{}, errXmlNs0EnclaveRunningAttestationAllOf
	}
	errXmlNs0EnclaveRunningAttestationAllOf = json.Unmarshal([]byte(serializedXmlNs0EnclaveRunningAttestationAllOf), &toSerialize)
	if errXmlNs0EnclaveRunningAttestationAllOf != nil {
		return []byte{}, errXmlNs0EnclaveRunningAttestationAllOf
	}
