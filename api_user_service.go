...
func (r ApiCancelSubscriptionRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	return r.ApiService.CancelSubscriptionExecute(r)
}

/*
 * CancelSubscription Method for CancelSubscription
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param planname
 * @param username
 * @return ApiCancelSubscriptionRequest
 */
func (a *UserServiceApiService) CancelSubscription(ctx _context.Context, planname string, username string) ApiCancelSubscriptionRequest {
	return ApiCancelSubscriptionRequest{
		ApiService: a,
		ctx: ctx,
		planname: planname,
 ...
 * @return *os.File
 */
func (a *UserServiceApiService) CancelSubscriptionExecute(r ApiCancelSubscriptionRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserServiceApiService.CancelSubscription")
	if err != nil {
		executionError.error = err.Error()
		return localVarReturnValue, nil, executionError
	}

	localVarPath := localBasePath + "/users/{username}/subscriptions/{planname}/cancel"
	localVarPath = strings.Replace(localVarPath, "{"+"planname"+"}", _neturl.PathEscape(parameterToString(r.planname, "")), -1)
...
func (r ApiCreateObjectRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *UserServiceApiService) CreateObjectExecute(r ApiCreateObjectRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiDeleteObjectRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *UserServiceApiService) DeleteObjectExecute(r ApiDeleteObjectRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiDeleteObject_0Request) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *UserServiceApiService) DeleteObject_1Execute(r ApiDeleteObject_0Request) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetAvatarsRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
...
func (r ApiGetCertificatesRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
...
func (r ApiGetEnclaveHistoryRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *UserServiceApiService) GetEnclaveHistoryExecute(r ApiGetEnclaveHistoryRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetObject2Request) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *UserServiceApiService) GetObject2Execute(r ApiGetObject2Request) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiSetAvatarRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *UserServiceApiService) SetAvatarExecute(r ApiSetAvatarRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiSetSettingsRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *UserServiceApiService) SetSettingsExecute(r ApiSetSettingsRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiUpdateObjectRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *UserServiceApiService) UpdateObjectExecute(r ApiUpdateObjectRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
