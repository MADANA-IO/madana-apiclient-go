...
// XmlNs0MDNSettingAllOf struct for XmlNs0MDNSettingAllOf
type XmlNs0MDNSettingAllOf struct {
	// 
...
func (o XmlNs0MDNSettingAllOf) MarshalJSON() ([]byte, error) {
...
type NullableXmlNs0MDNSettingAllOf struct {
	value *XmlNs0MDNSettingAllOf
	isSet bool
}

func (v NullableXmlNs0MDNSettingAllOf) Get() *XmlNs0MDNSettingAllOf {
	return v.value
}

func (v *NullableXmlNs0MDNSettingAllOf) Set(val *XmlNs0MDNSettingAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableXmlNs0MDNSettingAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableXmlNs0MDNSettingAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableXmlNs0MDNSettingAllOf(val *XmlNs0MDNSettingAllOf) *NullableXmlNs0MDNSettingAllOf {
	return &NullableXmlNs0MDNSettingAllOf{value: val, isSet: true}
}

func (v NullableXmlNs0MDNSettingAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableXmlNs0MDNSettingAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
