...
func (r ApiAuthenticateApplicationRequest) Execute() (JsonMDNToken, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return JsonMDNToken
 */
func (a *AuthenticationServiceApiService) AuthenticateApplicationExecute(r ApiAuthenticateApplicationRequest) (JsonMDNToken, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiAuthenticateEthereumWalletRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *AuthenticationServiceApiService) AuthenticateEthereumWalletExecute(r ApiAuthenticateEthereumWalletRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiAuthenticateUserRequest) Execute() (JsonMDNToken, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return JsonMDNToken
 */
func (a *AuthenticationServiceApiService) AuthenticateUserExecute(r ApiAuthenticateUserRequest) (JsonMDNToken, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiAuthenticateWithEthereumChallengeRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *AuthenticationServiceApiService) AuthenticateWithEthereumChallengeExecute(r ApiAuthenticateWithEthereumChallengeRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetFractalAuthenticationURLRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *AuthenticationServiceApiService) GetFractalAuthenticationURLExecute(r ApiGetFractalAuthenticationURLRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetNonceForEthereumWalletRequest) Execute() (JsonMDNToken, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return JsonMDNToken
 */
func (a *AuthenticationServiceApiService) GetNonceForEthereumWalletExecute(r ApiGetNonceForEthereumWalletRequest) (JsonMDNToken, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetObjectRequest) Execute() (map[string]map[string]interface{}, *_nethttp.Response, GenericOpenAPIError) {
 ...
 */
func (a *AuthenticationServiceApiService) GetObjectExecute(r ApiGetObjectRequest) (map[string]map[string]interface{}, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetTwitterAuthenticationURLRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *AuthenticationServiceApiService) GetTwitterAuthenticationURLExecute(r ApiGetTwitterAuthenticationURLRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiSetFacebookUIDRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *AuthenticationServiceApiService) SetFacebookUIDExecute(r ApiSetFacebookUIDRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiSetFractalUIDRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *AuthenticationServiceApiService) SetFractalUIDExecute(r ApiSetFractalUIDRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiSetTwitterUIDRequest) Execute() (*os.File, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return *os.File
 */
func (a *AuthenticationServiceApiService) SetTwitterUIDExecute(r ApiSetTwitterUIDRequest) (*os.File, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
