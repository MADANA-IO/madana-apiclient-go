...
func (o XmlNs0RunConfig) MarshalJSON() ([]byte, error) {
	...
	serializedXmlNs0RunConfigAllOf, errXmlNs0RunConfigAllOf := json.Marshal(o.XmlNs0RunConfigAllOf)
	if errXmlNs0RunConfigAllOf != nil {
		return []byte{}, errXmlNs0RunConfigAllOf
	}
	errXmlNs0RunConfigAllOf = json.Unmarshal([]byte(serializedXmlNs0RunConfigAllOf), &toSerialize)
	if errXmlNs0RunConfigAllOf != nil {
		return []byte{}, errXmlNs0RunConfigAllOf
	}
