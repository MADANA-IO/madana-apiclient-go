...
// GetAllRequests2Opts Optional parameters for the method 'GetAllRequests2'
type GetAllRequests2Opts struct {
    Authorization optional.String
...
/*
GetAllRequests2 Returns UUIDs of existing analyses.
Returns UUIDs of existing analyses.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetAllRequests2Opts - Optional Parameters:
 * @param "Authorization" (optional.String) -  Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c
...
@return *os.File
*/
func (a *RequestServiceApiService) GetAllRequests2(ctx _context.Context, localVarOptionals *GetAllRequests2Opts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
