...
func main() {
    uuid := "uuid_example" // string | 
    body := openapiclient.json_EnclaveRunningAttestationApproval{EnclaveProcess: openapiclient.json_EnclaveProcess{WireguardServer: "WireguardServer_example", InternalRemoteControlServer: "InternalRemoteControlServer_example", ConsoleOutput: "ConsoleOutput_example", AttestationServer: "AttestationServer_example", Environment: openapiclient.json_Environment{Size: "Size_example", Published: false, DefaultRunConfiguration: openapiclient.json_RunConfig{Args: []string{"Args_example"), DiskConfig: []JsonDiskConfig{openapiclient.json_Disk_config{Readonly: false, Disk: "Disk_example", RoothashOffset: 123, Roothash: "Roothash_example"}), Run: "Run_example", Environment: map[string]string{ "Key" = "Value" }}, Content: []string{"Content_example"), Name: "Name_example", Uuid: "Uuid_example", Packages: []string{"Packages_example"), RootHashOffset: "RootHashOffset_example", IpfsHash: "IpfsHash_example", Roothash: "Roothash_example", Description: "Description_example"}, EnclaveIdent: "EnclaveIdent_example", PublicIdent: "PublicIdent_example", Process: openapiclient.json_Process{OutputStream: 123, ErrorStream: 123, InputStream: 123, Alive: false}, EndingTime: "EndingTime_example", Status: "Status_example", InternalWireguardServer: "InternalWireguardServer_example", EnclaveInputstream: 123, WireguardPublicKey: "WireguardPublicKey_example", StartupCMD: "StartupCMD_example", InternalAttesationServer: "InternalAttesationServer_example", WgInterface: openapiclient.json_WireguardInterface{Address: "Address_example", Name: "Name_example", Port: "Port_example"}, SignerIdent: "SignerIdent_example", InternalIdent: "InternalIdent_example", RemoteControlServer: "RemoteControlServer_example", StartupTime: "StartupTime_example"}, NodeInfo: openapiclient.json_NodeInfo{Processors: []string{"Processors_example"), Status: "Status_example", IpfsInfo: openapiclient.json_IPFSSystemInfo{AgentVersion: "AgentVersion_example", Id: "Id_example", ProtocolVersion: "ProtocolVersion_example", SwarmConnection: "SwarmConnection_example", PublicKey: "PublicKey_example"}, OperatingSystemUptime: 123, CpuPhysicalCores: 123, CpuFamily: "CpuFamily_example", PublicKey: "PublicKey_example", OperatingSystem: "OperatingSystem_example", CpuModel: "CpuModel_example", ConnectionURL: "ConnectionURL_example", HardwareBaseboard: "HardwareBaseboard_example", CpuLogicalCount: 123, CpuFrequency: "CpuFrequency_example", Memory: "Memory_example", HardwareFirmware: "HardwareFirmware_example", Owner: "Owner_example"}, Approved: "Approved_example"} // JsonEnclaveRunningAttestationApproval |  (optional)
...
func main() {
    body := openapiclient.json_EnclaveRunRequest{EnclaveExecutionType: "EnclaveExecutionType_example", WireguardPublicKey: "WireguardPublicKey_example", EnvironmentUUID: "EnvironmentUUID_example", UsingDefaultRunConfig: false} // JsonEnclaveRunRequest |  (optional)
