...
func main() {
    ...
    body := openapiclient.json_SignedData{Signature: "Signature_example", Data: "Data_example", Fingerpint: "Fingerpint_example"} // JsonSignedData |  (optional)
...
func main() {
    uuid := "uuid_example" // string | 
    body := openapiclient.json_EnclaveRunningAttestationApproval{NodeInfo: openapiclient.json_NodeInfo{CpuModel: "CpuModel_example", CpuLogicalCount: 123, Owner: "Owner_example", OperatingSystemUptime: 123, OperatingSystem: "OperatingSystem_example", PublicKey: "PublicKey_example", ConnectionURL: "ConnectionURL_example", Memory: "Memory_example", HardwareBaseboard: "HardwareBaseboard_example", HardwareFirmware: "HardwareFirmware_example", CpuFrequency: "CpuFrequency_example", Status: "Status_example", IpfsInfo: openapiclient.json_IPFSSystemInfo{SwarmConnection: "SwarmConnection_example", Id: "Id_example", ProtocolVersion: "ProtocolVersion_example", AgentVersion: "AgentVersion_example", PublicKey: "PublicKey_example"}, Processors: []string{"Processors_example"), CpuFamily: "CpuFamily_example", CpuPhysicalCores: 123}, EnclaveProcess: openapiclient.json_EnclaveProcess{StartupCMD: "StartupCMD_example", InternalWireguardServer: "InternalWireguardServer_example", SignerIdent: "SignerIdent_example", Process: openapiclient.json_Process{Alive: false, OutputStream: 123, ErrorStream: 123, InputStream: 123}, RemoteControlServer: "RemoteControlServer_example", InternalIdent: "InternalIdent_example", Environment: openapiclient.json_Environment{Uuid: "Uuid_example", Packages: []string{"Packages_example"), Content: []string{"Content_example"), Roothash: "Roothash_example", Description: "Description_example", DefaultRunConfiguration: openapiclient.json_RunConfig{Args: []string{"Args_example"), Environment: map[string]string{ "Key" = "Value" }, DiskConfig: []JsonDiskConfig{openapiclient.json_Disk_config{Roothash: "Roothash_example", Readonly: false, RoothashOffset: 123, Disk: "Disk_example"}), Run: "Run_example"}, IpfsHash: "IpfsHash_example", Size: "Size_example", Name: "Name_example", Published: false, RootHashOffset: "RootHashOffset_example"}, WireguardServer: "WireguardServer_example", EndingTime: "EndingTime_example", AttestationServer: "AttestationServer_example", WgInterface: openapiclient.json_WireguardInterface{Address: "Address_example", Name: "Name_example", Port: "Port_example"}, StartupTime: "StartupTime_example", Status: "Status_example", EnclaveIdent: "EnclaveIdent_example", ConsoleOutput: "ConsoleOutput_example", InternalRemoteControlServer: "InternalRemoteControlServer_example", PublicIdent: "PublicIdent_example", InternalAttesationServer: "InternalAttesationServer_example", EnclaveInputstream: 123, WireguardPublicKey: "WireguardPublicKey_example"}, Approved: "Approved_example"} // JsonEnclaveRunningAttestationApproval |  (optional)
...
func main() {
    uuid := "uuid_example" // string | 
    body := openapiclient.json_NodeInfo{CpuModel: "CpuModel_example", CpuLogicalCount: 123, Owner: "Owner_example", OperatingSystemUptime: 123, OperatingSystem: "OperatingSystem_example", PublicKey: "PublicKey_example", ConnectionURL: "ConnectionURL_example", Memory: "Memory_example", HardwareBaseboard: "HardwareBaseboard_example", HardwareFirmware: "HardwareFirmware_example", CpuFrequency: "CpuFrequency_example", Status: "Status_example", IpfsInfo: openapiclient.json_IPFSSystemInfo{SwarmConnection: "SwarmConnection_example", Id: "Id_example", ProtocolVersion: "ProtocolVersion_example", AgentVersion: "AgentVersion_example", PublicKey: "PublicKey_example"}, Processors: []string{"Processors_example"), CpuFamily: "CpuFamily_example", CpuPhysicalCores: 123} // JsonNodeInfo |  (optional)
...
func main() {
    uuid := "uuid_example" // string | 
    body := openapiclient.json_EnclaveRunningAttestation{NodeInfo: , EnclaveProcess: openapiclient.json_EnclaveProcess{StartupCMD: "StartupCMD_example", InternalWireguardServer: "InternalWireguardServer_example", SignerIdent: "SignerIdent_example", Process: openapiclient.json_Process{Alive: false, OutputStream: 123, ErrorStream: 123, InputStream: 123}, RemoteControlServer: "RemoteControlServer_example", InternalIdent: "InternalIdent_example", Environment: openapiclient.json_Environment{Uuid: "Uuid_example", Packages: []string{"Packages_example"), Content: []string{"Content_example"), Roothash: "Roothash_example", Description: "Description_example", DefaultRunConfiguration: openapiclient.json_RunConfig{Args: []string{"Args_example"), Environment: map[string]string{ "Key" = "Value" }, DiskConfig: []JsonDiskConfig{openapiclient.json_Disk_config{Roothash: "Roothash_example", Readonly: false, RoothashOffset: 123, Disk: "Disk_example"}), Run: "Run_example"}, IpfsHash: "IpfsHash_example", Size: "Size_example", Name: "Name_example", Published: false, RootHashOffset: "RootHashOffset_example"}, WireguardServer: "WireguardServer_example", EndingTime: "EndingTime_example", AttestationServer: "AttestationServer_example", WgInterface: openapiclient.json_WireguardInterface{Address: "Address_example", Name: "Name_example", Port: "Port_example"}, StartupTime: "StartupTime_example", Status: "Status_example", EnclaveIdent: "EnclaveIdent_example", ConsoleOutput: "ConsoleOutput_example", InternalRemoteControlServer: "InternalRemoteControlServer_example", PublicIdent: "PublicIdent_example", InternalAttesationServer: "InternalAttesationServer_example", EnclaveInputstream: 123, WireguardPublicKey: "WireguardPublicKey_example"}} // JsonEnclaveRunningAttestation |  (optional)
...
func main() {
    body := openapiclient.json_EnclaveRunRequest{WireguardPublicKey: "WireguardPublicKey_example", EnclaveExecutionType: "EnclaveExecutionType_example", UsingDefaultRunConfig: false, EnvironmentUUID: "EnvironmentUUID_example"} // JsonEnclaveRunRequest |  (optional)
