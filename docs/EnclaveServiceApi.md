...
func main() {
    uuid := "uuid_example" // string | 
    body := openapiclient.json_EnclaveRunningAttestationApproval{EnclaveProcess: openapiclient.json_EnclaveProcess{Environment: openapiclient.json_Environment{IpfsHash: "IpfsHash_example", Size: "Size_example", Content: []string{"Content_example"), Roothash: "Roothash_example", Packages: []string{"Packages_example"), Name: "Name_example", RootHashOffset: "RootHashOffset_example", DefaultRunConfiguration: openapiclient.json_RunConfig{Run: "Run_example", DiskConfig: []JsonDiskConfig{openapiclient.json_Disk_config{RoothashOffset: 123, Readonly: false, Roothash: "Roothash_example", Disk: "Disk_example"}), Environment: map[string]string{ "Key" = "Value" }, Args: []string{"Args_example")}, Description: "Description_example", Published: false, Uuid: "Uuid_example"}, InternalAttesationServer: "InternalAttesationServer_example", Process: openapiclient.json_Process{InputStream: 123, ErrorStream: 123, OutputStream: 123, Alive: false}, ConsoleOutput: "ConsoleOutput_example", Status: "Status_example", InternalWireguardServer: "InternalWireguardServer_example", WireguardPublicKey: "WireguardPublicKey_example", StartupCMD: "StartupCMD_example", RemoteControlServer: "RemoteControlServer_example", EnclaveIdent: "EnclaveIdent_example", InternalIdent: "InternalIdent_example", EndingTime: "EndingTime_example", StartupTime: "StartupTime_example", WgInterface: openapiclient.json_WireguardInterface{Address: "Address_example", Name: "Name_example", Port: "Port_example"}, SignerIdent: "SignerIdent_example", WireguardServer: "WireguardServer_example", EnclaveInputstream: 123, InternalRemoteControlServer: "InternalRemoteControlServer_example", AttestationServer: "AttestationServer_example", PublicIdent: "PublicIdent_example"}, NodeInfo: openapiclient.json_NodeInfo{Processors: []string{"Processors_example"), OperatingSystemUptime: 123, ConnectionURL: "ConnectionURL_example", OperatingSystem: "OperatingSystem_example", CpuFamily: "CpuFamily_example", HardwareBaseboard: "HardwareBaseboard_example", Status: "Status_example", PublicKey: "PublicKey_example", Memory: "Memory_example", CpuPhysicalCores: 123, CpuLogicalCount: 123, HardwareFirmware: "HardwareFirmware_example", CpuFrequency: "CpuFrequency_example", IpfsInfo: openapiclient.json_IPFSSystemInfo{SwarmConnection: "SwarmConnection_example", ProtocolVersion: "ProtocolVersion_example", Id: "Id_example", PublicKey: "PublicKey_example", AgentVersion: "AgentVersion_example"}, Owner: "Owner_example", CpuModel: "CpuModel_example"}, Approved: "Approved_example"} // JsonEnclaveRunningAttestationApproval |  (optional)
...
func main() {
    uuid := "uuid_example" // string | 
    body := openapiclient.json_NodeInfo{Processors: []string{"Processors_example"), OperatingSystemUptime: 123, ConnectionURL: "ConnectionURL_example", OperatingSystem: "OperatingSystem_example", CpuFamily: "CpuFamily_example", HardwareBaseboard: "HardwareBaseboard_example", Status: "Status_example", PublicKey: "PublicKey_example", Memory: "Memory_example", CpuPhysicalCores: 123, CpuLogicalCount: 123, HardwareFirmware: "HardwareFirmware_example", CpuFrequency: "CpuFrequency_example", IpfsInfo: openapiclient.json_IPFSSystemInfo{SwarmConnection: "SwarmConnection_example", ProtocolVersion: "ProtocolVersion_example", Id: "Id_example", PublicKey: "PublicKey_example", AgentVersion: "AgentVersion_example"}, Owner: "Owner_example", CpuModel: "CpuModel_example"} // JsonNodeInfo |  (optional)
...
func main() {
    uuid := "uuid_example" // string | 
    body := openapiclient.json_EnclaveRunningAttestation{EnclaveProcess: openapiclient.json_EnclaveProcess{Environment: openapiclient.json_Environment{IpfsHash: "IpfsHash_example", Size: "Size_example", Content: []string{"Content_example"), Roothash: "Roothash_example", Packages: []string{"Packages_example"), Name: "Name_example", RootHashOffset: "RootHashOffset_example", DefaultRunConfiguration: openapiclient.json_RunConfig{Run: "Run_example", DiskConfig: []JsonDiskConfig{openapiclient.json_Disk_config{RoothashOffset: 123, Readonly: false, Roothash: "Roothash_example", Disk: "Disk_example"}), Environment: map[string]string{ "Key" = "Value" }, Args: []string{"Args_example")}, Description: "Description_example", Published: false, Uuid: "Uuid_example"}, InternalAttesationServer: "InternalAttesationServer_example", Process: openapiclient.json_Process{InputStream: 123, ErrorStream: 123, OutputStream: 123, Alive: false}, ConsoleOutput: "ConsoleOutput_example", Status: "Status_example", InternalWireguardServer: "InternalWireguardServer_example", WireguardPublicKey: "WireguardPublicKey_example", StartupCMD: "StartupCMD_example", RemoteControlServer: "RemoteControlServer_example", EnclaveIdent: "EnclaveIdent_example", InternalIdent: "InternalIdent_example", EndingTime: "EndingTime_example", StartupTime: "StartupTime_example", WgInterface: openapiclient.json_WireguardInterface{Address: "Address_example", Name: "Name_example", Port: "Port_example"}, SignerIdent: "SignerIdent_example", WireguardServer: "WireguardServer_example", EnclaveInputstream: 123, InternalRemoteControlServer: "InternalRemoteControlServer_example", AttestationServer: "AttestationServer_example", PublicIdent: "PublicIdent_example"}, NodeInfo: } // JsonEnclaveRunningAttestation |  (optional)
...
func main() {
    body := openapiclient.json_EnclaveRunRequest{EnvironmentUUID: "EnvironmentUUID_example", EnclaveExecutionType: "EnclaveExecutionType_example", WireguardPublicKey: "WireguardPublicKey_example", UsingDefaultRunConfig: false} // JsonEnclaveRunRequest |  (optional)
