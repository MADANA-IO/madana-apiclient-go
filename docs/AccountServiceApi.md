...
func main() {
    body := openapiclient.json_MDN_PasswordReset{Mail: "Mail_example", Password: "Password_example", Token: "Token_example"} // JsonMDNPasswordReset | - the MDN_PasswordReset Object (optional)
