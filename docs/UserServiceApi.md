...
func main() {
    ...
    body := openapiclient.json_MDN_User{LastActive: "LastActive_example", UserName: "UserName_example", Created: "Created_example", Activated: "Activated_example", Image: "Image_example", SocialAccounts: []JsonMDNSocialUserObject{openapiclient.json_MDN_SocialUserObject{Ident: "Ident_example", Image: "Image_example", Platform: "Platform_example"}), Guid: "Guid_example", LastName: "LastName_example", Settings: []JsonMDNUserSetting{openapiclient.json_MDN_UserSetting{Id: "Id_example", Description: "Description_example", Name: "Name_example", Value: "Value_example"}), FirstName: "FirstName_example", Credentials: openapiclient.json_MDN_UserCredentials{Username: "Username_example", Password: "Password_example"}, Mail: "Mail_example"} // JsonMDNUser | provided user object inheriting properties and credentials (optional)
...
func main() {
    username := "username_example" // string | 
    body := openapiclient.json_MDN_UserSetting{Id: "Id_example", Description: "Description_example", Name: "Name_example", Value: "Value_example"} // JsonMDNUserSetting |  (optional)
...
func main() {
    username := "username_example" // string | 
    body := openapiclient.json_MDN_User{LastActive: "LastActive_example", UserName: "UserName_example", Created: "Created_example", Activated: "Activated_example", Image: "Image_example", SocialAccounts: []JsonMDNSocialUserObject{openapiclient.json_MDN_SocialUserObject{Ident: "Ident_example", Image: "Image_example", Platform: "Platform_example"}), Guid: "Guid_example", LastName: "LastName_example", Settings: []JsonMDNUserSetting{), FirstName: "FirstName_example", Credentials: openapiclient.json_MDN_UserCredentials{Username: "Username_example", Password: "Password_example"}, Mail: "Mail_example"} // JsonMDNUser | the new user object inherting all properties that should be change (optional)
