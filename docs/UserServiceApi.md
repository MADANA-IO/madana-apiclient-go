...
func main() {
    ...
    body := openapiclient.json_MDN_User{Created: "Created_example", Image: "Image_example", Activated: "Activated_example", LastActive: "LastActive_example", UserName: "UserName_example", LastName: "LastName_example", SocialAccounts: []JsonMDNSocialUserObject{openapiclient.json_MDN_SocialUserObject{Platform: "Platform_example", Image: "Image_example", Ident: "Ident_example"}), FirstName: "FirstName_example", Settings: []JsonMDNUserSetting{openapiclient.json_MDN_UserSetting{Description: "Description_example", Id: "Id_example", Name: "Name_example", Value: "Value_example"}), Mail: "Mail_example", Credentials: openapiclient.json_MDN_UserCredentials{Username: "Username_example", Password: "Password_example"}, Guid: "Guid_example"} // JsonMDNUser | provided user object inheriting properties and credentials (optional)
...
func main() {
    username := "username_example" // string | 
    body := openapiclient.json_MDN_User{Created: "Created_example", Image: "Image_example", Activated: "Activated_example", LastActive: "LastActive_example", UserName: "UserName_example", LastName: "LastName_example", SocialAccounts: []JsonMDNSocialUserObject{openapiclient.json_MDN_SocialUserObject{Platform: "Platform_example", Image: "Image_example", Ident: "Ident_example"}), FirstName: "FirstName_example", Settings: []JsonMDNUserSetting{), Mail: "Mail_example", Credentials: openapiclient.json_MDN_UserCredentials{Username: "Username_example", Password: "Password_example"}, Guid: "Guid_example"} // JsonMDNUser | the new user object inherting all properties that should be change (optional)
