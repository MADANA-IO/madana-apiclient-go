...
func main() {
    ...
    body := openapiclient.json_MDN_User{LastActive: "LastActive_example", Created: "Created_example", Activated: "Activated_example", UserName: "UserName_example", Image: "Image_example", FirstName: "FirstName_example", Mail: "Mail_example", LastName: "LastName_example", SocialAccounts: []JsonMDNSocialUserObject{openapiclient.json_MDN_SocialUserObject{Platform: "Platform_example", Image: "Image_example", Ident: "Ident_example"}), Settings: []JsonMDNUserSetting{openapiclient.json_MDN_UserSetting{Name: "Name_example", Description: "Description_example", Id: "Id_example", Value: "Value_example"}), Credentials: openapiclient.json_MDN_UserCredentials{Username: "Username_example", Password: "Password_example"}, Guid: "Guid_example"} // JsonMDNUser | provided user object inheriting properties and credentials (optional)
...
func main() {
    username := "username_example" // string | 
    body := openapiclient.json_MDN_UserSetting{Name: "Name_example", Description: "Description_example", Id: "Id_example", Value: "Value_example"} // JsonMDNUserSetting |  (optional)
...
func main() {
    username := "username_example" // string | 
    body := openapiclient.json_MDN_User{LastActive: "LastActive_example", Created: "Created_example", Activated: "Activated_example", UserName: "UserName_example", Image: "Image_example", FirstName: "FirstName_example", Mail: "Mail_example", LastName: "LastName_example", SocialAccounts: []JsonMDNSocialUserObject{openapiclient.json_MDN_SocialUserObject{Platform: "Platform_example", Image: "Image_example", Ident: "Ident_example"}), Settings: []JsonMDNUserSetting{), Credentials: openapiclient.json_MDN_UserCredentials{Username: "Username_example", Password: "Password_example"}, Guid: "Guid_example"} // JsonMDNUser | the new user object inherting all properties that should be change (optional)
