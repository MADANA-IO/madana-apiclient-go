...
func main() {
    body := openapiclient.json_EnvironmentPublishingRequest{Uuid: "Uuid_example", Name: "Name_example", Size: "Size_example", Packages: "Packages_example", Content: "Content_example", Description: "Description_example", IpfsHash: "IpfsHash_example", IsPublic: "IsPublic_example", IpfsPrimaryPeer: "IpfsPrimaryPeer_example"} // JsonEnvironmentPublishingRequest |  (optional)
